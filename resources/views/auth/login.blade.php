...
<head>
    ...
    <title>Connexion - EduMarket</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="{{ route('home') }}" class="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-indigo-600">Accueil</a>
                    <a href="{{ route('signup') }}" class="px-3 py-2 rounded-md text-sm font-medium text-indigo-600">S'inscrire</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <footer class="bg-white">
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <p class="text-center text-sm text-gray-500">
                &copy; 2025 EduMarket. Tous droits réservés.
            </p>
        </div>
    </footer>
</body>
